...
#define QMD_FEATURE_BBM				3
#define QMD_FEATURE_TRIM			4
#endif
//////////////////////////////////////////////////////////
	...
	struct badblocks {
		...
		int prev_count; /* Patch by QNAP: record the previous count of bad blocks*/
...
#define MD_QNAP_HOTREPLACE 12 //[SDMD] csw: only used for hot-replace
    ...
    struct work_struct qnap_bbm_work; //Patch by QNAP: doing for qnap bbm stripe error in rebuilding mode
	void (*sync_super)(struct mddev *mddev, struct md_rdev *rdev);

#ifdef CONFIG_USE_STRIPE_ZONE
	sector_t work_sectors[MD_MAX_DISKS];
#endif
 ...
 * #define QMD_FEATURE_BBM
 ************************************************************/
	unsigned long qflags;
    atomic_t qnap_bbm_stripe_error; //Patch by QNAP: a flag that describe if it is qnap_bbm_stripe_error or not
    atomic_t qnap_bbm_readonly; //Patch by QNAP: a flag that describe if it is qnap_bbm_readonly or not
#endif
};
