...
//Patch by QNAP: enhance HAL error handler
	...
	//Patch by QNAP: fix bug #46881 on bugZilla
	//We shold release the spin lock before return from this function. 
	//Otherwise, it would cause the system hang-up issue.
	spin_unlock_irqrestore(&conf->device_lock, flags);
