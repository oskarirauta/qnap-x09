...
int (*ahci_init_mv9235_i2c)(struct pci_dev *, void __iomem *) = NULL;
EXPORT_SYMBOL(ahci_init_mv9235_i2c);
#endif
...
static const struct pci_device_id ahci_pci_tbl[] = {
	...
	/* Marvell */
//Patch by QNAP:use mv61xx.ko not use AHCI for Marvell 6145
#ifdef CONFIG_MACH_QNAPTS
#if defined(QNAP_HAL)
...
//#ifdef CONFIG_I2C_MV9235
		//dev_info(&pdev->dev, "Init MV_9235_I2C\n");
		if (ahci_init_mv9235_i2c != NULL)
		    ahci_init_mv9235_i2c(pdev, hpriv->mmio);
//#endif
