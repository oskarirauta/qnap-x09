...
// For thunderbolt JBOD, using Marvel 9235 Sata controller to access I2C devices
#include "mv9235_i2c.h"
#include "ahci.h"
int (*ahci_remove_mv9235_i2c)(struct pci_dev *, void __iomem *) = NULL;
EXPORT_SYMBOL(ahci_remove_mv9235_i2c);
#endif
////////////////////////////////////////////////////////////////
...
#ifdef CONFIG_MACH_QNAPTS
    // Don't speed down when drive plug in or out
    if (!(link->eh_context.i.serror & (SERR_PHYRDY_CHG)))
    {
        // Speed down for ICRC, Disparity ,10B8B or Handshake BadCRC error 
        if ((link->eh_context.i.serror & (SERR_10B_8B_ERR | SERR_DISPARITY | SERR_HANDSHAKE | SERR_CRC))
...
static void ata_port_detach(struct ata_port *ap)
{
 ...
 skip_eh:
	...
	// Change the removal ordering in ata_port_detach()
	// so that the SCSI host is removed from the port before ata_tport_delete() is called.
	//ata_tport_delete(ap);
...
void ata_pci_remove_one(struct pci_dev *pdev)
{
	...
	hpriv  = (struct ahci_host_priv *) host->private_data;
	if (pdev->vendor == 0x1b4b && pdev->device == 0x9235) {
		//mv9235_i2c_remove(pdev);
		if (ahci_remove_mv9235_i2c)
		{
		    ahci_remove_mv9235_i2c(pdev, hpriv->mmio);
		    printk("ata_pci_remove_one() : Find and remove MV9235 I2C\n");
		}
	}
#endif
