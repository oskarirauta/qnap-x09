...
//	[2014-05-21 by LIN_WC]: Patched for QNAP show default image (HD Station), image is 800x600 size
#ifdef CONFIG_MACH_QNAPTS
		DRM_INFO("Cannot find any crtc or sizes - going 800x600\n");
		sizes.fb_width = sizes.surface_width = 800;
		sizes.fb_height = sizes.surface_height = 600;
#else
