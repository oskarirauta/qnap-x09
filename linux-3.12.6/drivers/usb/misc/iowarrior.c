...
#define USB_DEVICE_ID_CODEMERCS_IOWAXIS	0x1589
#endif
...
#ifdef CONFIG_MACH_QNAPTS
	{USB_DEVICE(USB_VENDOR_ID_CODEMERCS, USB_DEVICE_ID_CODEMERCS_IOWAXIS)},
#endif
	{}			/* Terminating entry */
};
...
#ifdef CONFIG_MACH_QNAPTS
	case USB_DEVICE_ID_CODEMERCS_IOWAXIS:
#endif
							...
							unsigned long arg)
{
	...
	case IOW_WRITE:
		if (dev->product_id == USB_DEVICE_ID_CODEMERCS_IOW24 ||
		    ...
		    dev->product_id == USB_DEVICE_ID_CODEMERCS_IOWAXIS) {
#else
		    dev->product_id == USB_DEVICE_ID_CODEMERCS_IOW40) {
#endif
