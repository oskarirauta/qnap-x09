					 ...
					 struct nfsd_diropres   *resp)
{
	...
	// QNAP patch: Remove acl permission check on all operations -- added by CindyJen@2014.03
#ifdef CONFIG_MACH_QNAPTS
	dchild = lookup_one_len_without_acl(argp->name, dirfhp->fh_dentry, argp->len);
#else
