...
#define EXT4_MOUNT_RICH_ACL		0x40000 /* RICH Access Control Lists */
#endif
...
// tbd		      (EXT4_I(dir)->i_flags & EXT4_INDEX_FL))
#else
...
#ifdef CONFIG_MACH_QNAPTS
extern int ext4_claim_free_clusters(struct super_block *sb,
