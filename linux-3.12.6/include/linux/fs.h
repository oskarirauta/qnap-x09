...
/* Device file was opened with journalling support (only for block device) */
#define FMODE_JOURNAL_SUPPORT	((__force fmode_t)0x2000000)
#endif
...
struct fiemap_extent_info {
    ...
    union {
        ...
        /* Start of fiemap_extent array */
        struct fiemap_extent *kfi_extents_start;
        /* Kernel version of last array */
    };
...
/*
 * THIN BLOCK SIZE FOR SERVER-SIDE COPY ACCELERATION
 */
#define THIN_BLOCK_BYTES 1048576
#define THIN_BLOCK_SHIFT 20
...
//	[2014-03-24 by LIN_WC]:replace drm from Linux Kernel 3.13.6
#ifdef CONFIG_MACH_QNAPTS
/*
...
#ifdef QNAP_DEDUPE
extern ssize_t generic_splice_write_from_socket(struct file *,
		struct socket *, loff_t __user *, size_t);
extern long do_splice_to(struct file *in, loff_t *ppos,
		struct pipe_inode_info *pipe, size_t len, unsigned int flags);
extern ssize_t default_splice_from_zero(loff_t *ppos,
		struct pipe_inode_info *pipe, size_t len, unsigned int flags);
#endif
