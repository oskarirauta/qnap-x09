...
struct target_type {
	...
	dm_ioctl_fn ioctl;
#ifdef CONFIG_MACH_QNAPTS
	dm_ioctl_fn compat_ioctl;	//Add for QNAP flashcache by Johnny
...
#ifdef CONFIG_MACH_QNAPTS
	dm_open_count_fn open_count;	// Add for QNAP QDM by Burton
#endif
